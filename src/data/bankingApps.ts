...
export const bankingApplications: BankingApplication[] = [
  {
    ...
    journeySteps: [
      ...
      },
      {
        ...
        description: 'Convert lead to customer and create account',
        status: 'pending',
        icon: 'Wallet',
        crmActions: [
          {
            ...
            description: 'Convert verified lead to customer account',
            endpoint: '/api/crm/leads/{leadId}/convert',
            method: 'POST',
            payload: {
              accountType: 'SAVINGS',
              initialDeposit: 1000,
